...
const URIupdateproducto = "http://localhost:8000/updateproducto/";
...
function ProductUpdate() {
  ...
  const getProductoById = async () => {
    const res = await axios.get(URIproducto + id);
    const productoData = res.data;
    setNombre(productoData.nombre);
    setSelectedCategoria({
      id: productoData.id_categoria,
      name: productoData.nombre_categoria,
    });
    setSelectedSubCategoria({
      id: productoData.id_subcategoria,
      name: productoData.nombre_categoria,
    });
    setCod(productoData.cod);
    setDisponibilidad(productoData.disponibilidad);
